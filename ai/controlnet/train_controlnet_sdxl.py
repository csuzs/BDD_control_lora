...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="lora checkpoint path to add to sdxl. If not provided, no lora will be loaded",
    )
    ...
    if args.resolution[0] % 8 != 0 or args.resolution[1] % 8 != 0:
        raise ValueError(
...
def main(args):
    ...
    if args.lora_path:
        ...
        lora_state_dict,network_alphas = StableDiffusionLoraLoaderMixin.lora_state_dict(args.lora_path)
        StableDiffusionLoraLoaderMixin.load_lora_into_unet(lora_state_dict,network_alphas,unet)
    ...
    def compute_embeddings(batch, proportion_empty_prompts, text_encoders, tokenizers, is_train=True):
        original_size = tuple(args.resolution)
        target_size = tuple(args.resolution)
