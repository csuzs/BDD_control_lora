...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="Path to the LoRA checkpoint to load for inference.",
    )
    parser.add_argument(
...
def main(args):
    ...
    if accelerator.is_main_process:
        ...
        pipeline.load_lora_weights(args.lora_ckpt_path)

        # run inference
        images = []
        epoch=0
        if args.validation_prompt and args.num_validation_images > 0:
            pipeline_args = {"prompt": args.validation_prompt, "num_inference_steps": 40,"negative_prompt": "cartoon"}
            ...
            for i, image in enumerate(images):
                image.save(os.path.join(args.output_dir, f"validation_image_{i}.png"))
